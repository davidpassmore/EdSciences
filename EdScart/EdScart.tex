...
\Author{David L.
Passmore$^{1,2,\ddagger,*}$\href{https://orcid.org/0000-0001-9307-5164}{\orcidicon}, Chungil
Chae$^{2, \dagger, \ddagger}$}

% Authors, for metadata in PDF
\AuthorNames{David L. Passmore, Chungil Chae}

% Affiliations / Addresses (Add [1] after \address if there is only one affiliation.)
\address{%
$^{1}$ \quad 5 Bayard Road, Unit 403, Pittsburgh, Pennsylvania
15213-1903
USA; \href{mailto:dlp@davidpassmore.net}{\nolinkurl{dlp@davidpassmore.net}}\\
$^{2}$ \quad Wenzhou-Kean University 88 Dexue Rd, Wenzhou,
China; \href{mailto:cchae@kean.edu}{\nolinkurl{cchae@kean.edu}}\\
}
% Contact information of the corresponding author
\corres{Correspondence: \href{mailto:dlp@davidpassmore.net}{\nolinkurl{dlp@davidpassmore.net}};
Tel.: +1-814-571-8937.}
...
materials, data, computer code, and protocols \footnote{Testing the
  footnote}associated with the publication available to readers. Please
